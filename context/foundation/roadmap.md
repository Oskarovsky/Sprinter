...
- **S-04: session facilitator can link one GitHub or GitLab repository (public or private); after reveal, all participants see a visually distinct reference-only Analyst story-point vote and rationale excluded from the human average.** — Archived 2026-06-01 → `context/archive/2026-05-30-sprinter-analyst-vote/`. Lesson: —.
